...
form.addEventListener('submit', (e) => {
    ...
    const ra = document.getElementById('ra').value; // Adicionado na branch criada pela Julia
    ...
    li.textContent = `RA: ${ra} - ${nome} (${email})`; // Linha modificada para incluir o RA na exibição
    ...
    document.getElementById('ra').value = ''; // Linha para limpar o campo
});